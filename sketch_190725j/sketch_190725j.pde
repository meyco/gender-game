...
int nrOfImages = 25;
// COUNT UP TIMER
int startingTime;//count UP
int seconds;
int minutes;
int hours;
int finalSeconds;//keep time for result
int finalMinutes;
// GAME VARIABLES
int gameState = 1;
int keyman = 0;
...
void draw()
{
  ...
  switch(gameState)
  {
    ...
    lazyscreen.textFont(font);                  // STEP 3 Specify font to be used
